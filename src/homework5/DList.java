...
public class DList extends List {
	...
	public DList() {
		size = 0;
		head = newNode(null, this, head, head);
	}

	public boolean contains(Object o) throws InvalidNodeException{
		DListNode node = (DListNode) front();
	...
	public void insertFront(Object item) {
		...
		DListNode node = (DListNode)(front());
		node.prev = this.newNode(item, this, head, node);
	}
	...
	public void insertBack(Object item) {
		// Your solution here.  Similar to Homework 4, but now you need to specify
		//   the `list' field (second parameter) as well.
		DListNode node = (DListNode)(back());
		node.next = this.newNode(item, this, node, head);
	}
