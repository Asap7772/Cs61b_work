...
public class DListNode extends ListNode {
	...
	protected DList myDList = (DList)(myList);
	/**
	...
	public void insertAfter(Object item) throws InvalidNodeException {
		...
		DListNode next = this.next;
		DListNode add = myDList.newNode(item, myDList, this, next);
		this.next = add;
		next.prev = add;
	}
	...
	public void insertBefore(Object item) throws InvalidNodeException {
		...
		DListNode add = myDList.newNode(item, myDList, prev, this);
		this.prev = add;
		prev.next = add;
